...
export default function RoastEntryForm() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Visualización de la Curva en la parte superior para referencia inmediata */}
            <section className="bg-bg-card/30 rounded-[3rem] p-2 border border-white/5">
                <RoastCurveAnalysis />
            </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <section className="bg-bg-card border border-white/5 p-8 rounded-3xl relative overflow-hidden">
                        ...
                        <h3 className="text-brand-green-bright font-bold mb-6">Resultados Post-Tostión</h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className={`mt-8 p-6 rounded-2xl border transition-all ${yieldLoss && yieldLoss > 16 ? 'bg-brand-red/10 border-brand-red/30' : 'bg-white/5 border-white/5'}`}>
                                <div className="flex justify-between items-center">
                                    <span className="text-sm font-medium text-gray-400">Merma Final</span>
                ...
                >
                    {isSubmitting ? 'GUARDANDO EN NUBE...' : 'FINALIZAR Y REGISTRAR LOTE'}
                    {!isSubmitting && (
