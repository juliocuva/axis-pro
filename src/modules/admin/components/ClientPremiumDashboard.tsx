...
export default function ClientPremiumDashboard({ user }: { user: any }) {
    ...
    if (isLoading) return <div className="text-center py-20 text-brand-navy-bright animate-pulse">Analizando Inteligencia de Negocio...</div>;

    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            <header className="flex justify-between items-end border-b border-gray-400 shadow-sm pb-6">
                <div>
                    <h2 className="text-3xl font-black text-brand-navy outline-none uppercase er flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-bg-card border border-gray-400 shadow-sm p-8 rounded-industrial flex flex-col relative overflow-hidden group hover:border-gray-400 shadow-sm transition-all">
                    ...
                    <div className="relative z-10 flex-1">
                        <h4 className="text-[11px] font-bold text-brand-navy uppercase  mb-1">Indicador Legal y Logístico</h4>
                        <p className="text-lg font-bold text-brand-navy uppercase  mb-6">Índice EUDR (Semáforo Export)</p>
                ...
                <div className="bg-bg-card border border-gray-400 shadow-sm p-8 rounded-industrial flex flex-col relative overflow-hidden group hover:border-gray-400 shadow-sm transition-all">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white blur-3xl pointer-events-none group-hover:bg-white transition-colors"></div>
                    <div className="relative z-10 flex-1">
                        <h4 className="text-[11px] font-bold text-brand-navy uppercase  mb-1">Previsibilidad de Perfil</h4>
                        <p className="text-lg font-bold text-brand-navy uppercase  mb-2">Consistencia Sensorial (Q-Score)</p>
                        ...
                        <div className="flex justify-center gap-4 text-[9px] font-bold uppercase  mt-2">
                            <span className="flex items-center gap-1 text-brand-navy-bright"><span className="w-2 h-2 bg-brand-green rounded-full"></span> Último Lote</span>
                            <span className="flex items-center gap-1 text-brand-navy-bright"><span className="w-2 h-2 border-2 border-black-bright border-dashed rounded-full"></span> Promedio Anual</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-bg-card border border-gray-400 shadow-sm p-8 rounded-industrial flex flex-col relative overflow-hidden group hover:border-gray-400 shadow-sm transition-all">
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        <div>
                            <h4 className="text-[11px] font-bold text-brand-navy uppercase  mb-1">Retorno de Inversión</h4>
                            <p className="text-lg font-bold text-brand-navy uppercase  mb-2">Prima de Valor de Origen</p>
                        </div>
                        ...
                        <p className="text-[9px] text-brand-navy leading-relaxed bg-white p-3 rounded-md border border-gray-400 shadow-sm">
                            Diferencia entre el precio de commodity y el precio de especialidad validado mediante el <span className="text-brand-navy font-bold">Registro de Trazabilidad AXIS</span>.
                        </p>
                    </div>
                </div>
