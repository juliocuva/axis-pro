                ...
                <header className="p-8 border-b border-gray-400 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center bg-black/40 gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-[11px] text-brand-navy font-mono">REGISTROS DE TUESTES</span>
                        </div>
                ...
                <div className="flex-1 overflow-auto p-8">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-64 opacity-50">
                            ...
                            <p className="text-[12px] text-brand-navy font-bold uppercase ">No hay tuestes registrados para este cliente</p>
                        </div>
                    ) : (
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-white border-b border-gray-400 shadow-sm">
                                    <th className="p-4 text-[11px] font-bold text-brand-navy uppercase ">Tueste / ID</th>
                                    <th className="p-4 text-[11px] font-bold text-brand-navy uppercase ">Fecha</th>
                                    <th className="p-4 text-[11px] font-bold text-brand-navy uppercase  text-right">Peso Verde (kg)</th>
                                    <th className="p-4 text-[11px] font-bold text-brand-navy uppercase  text-right">Peso Tostado (kg)</th>
                                    ...
                                    <tr key={roast.id} className="hover:bg-white/[0.02] transition-colors group">
                                        <td className="p-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-[12px] font-bold text-brand-navy uppercase ">{roast.batch_id_label || 'S/N'}</p>
                                        ...
                                        <td className="p-4 text-right">
                                            <span className="text-14px font-bold text-brand-navy">{roast.roasted_weight || 0}</span>
                                        </td>
                                        <td className="p-4 text-right">
