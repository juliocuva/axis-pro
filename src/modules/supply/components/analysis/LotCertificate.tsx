            ...
            <div className="bg-bg-main p-8 md:p-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 shadow-inner">
                <div className="flex items-center gap-6 flex-1 w-full md:w-auto">
                    <div className="w-20 h-20 bg-white p-2 rounded-xl shadow-2xl relative group shrink-0">
                        <img
                            src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://axis-coffee.pro"
                            alt="QR Trazabilidad"
                ...
                <div className="flex gap-2 shrink-0 w-full md:w-auto">
                    <button
                        ...
                        className="flex-1 md:flex-none px-5 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl font-bold transition-all border border-white/5 uppercase tracking-widest text-[8px] flex items-center justify-center gap-2"
                    >
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2" /><rect x="6" y="14" width="12" height="8" /></svg>
                        Exportar
                    </button>
                    <button
                        className="flex-1 md:flex-none px-5 py-3 bg-brand-green hover:bg-brand-green-bright text-white rounded-xl font-bold transition-all shadow-lg shadow-brand-green/20 uppercase tracking-widest text-[8px] flex items-center justify-center gap-2"
                    >
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M12 2v10m0 0l-3-3m3 3l3-3" /><path d="M22 10a10 10 0 11-20 0" /></svg>
                        Compartir
                    </button>
                    <button
                        onClick={onClose}
                        className="flex-1 md:flex-none px-5 py-3 bg-white/5 hover:bg-red-500/20 text-gray-400 hover:text-red-400 rounded-xl font-bold transition-all border border-white/5 uppercase tracking-widest text-[8px] flex items-center justify-center"
                    >
                        Cerrar
                    </button>
                </div>
