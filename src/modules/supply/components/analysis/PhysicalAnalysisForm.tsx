    ...
    return (
        <div className="bg-bg-card border border-white/5 p-8 rounded-industrial space-y-8 animate-in fade-in duration-500 relative min-h-[400px]">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <section className="bg-brand-green/5 border border-brand-green/10 p-8 rounded-industrial space-y-6 mt-8">
                    <div className="flex justify-between items-center mb-4">
                        <h4 className="text-[10px] font-bold text-brand-green-bright uppercase tracking-[0.2em]">ANÁLISIS FISICOQUÍMICO (LABORATORIO)</h4>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                disabled={isSubmitting || isAlreadyAnalyzed}
                                className={`w-full bg-bg-main border border-white/10 rounded-industrial-sm px-4 py-3 text-xs font-bold text-white outline-none focus:border-brand-green uppercase appearance-none transition-all ${isAlreadyAnalyzed ? 'opacity-50' : ''}`}
                    ...
                    {physicochemicalData.agente_infusion && (
                        <div className="p-4 bg-brand-green/5 border border-brand-green/20 rounded-industrial-sm">
                            <label className="text-[9px] font-bold text-brand-green-bright uppercase tracking-widest block mb-2">Saborizante / Co-Fermento</label>
