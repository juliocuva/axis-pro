    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="text-center mb-12">
                <h2 className="text-5xl font-black text-black uppercase er mb-2">RECONOCIMIENTO</h2>
                <p className="text-[11px] font-bold text-black uppercase ">Axis Foundation • Cross-Border Gratitude Protocol</p>
            </div>
            {/* Header / Stats */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white border border-gray-400 shadow-sm p-6 rounded-3xl flex flex-col items-center text-center">
                    ...
                    <p className="text-3xl font-black text-black">4.92</p>
                </div>
                <div className="bg-white border border-gray-400 shadow-sm p-6 rounded-3xl flex flex-col items-center text-center">
                    <div className="w-12 h-12 rounded-full bg-white border border-gray-400 shadow-sm flex items-center justify-center mb-4">
                        <span className="text-black font-black">❤</span>
                ...
                <div className="bg-white border border-gray-400 shadow-sm p-6 rounded-3xl flex flex-col items-center text-center">
                    ...
                    <p className="text-3xl font-black text-black">+$450.00</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <section className="bg-bg-card border border-gray-400 shadow-sm rounded-[32px] p-8">
                    <div className="flex justify-between items-center mb-8">
                        <h3 className="text-black-bright text-[11px] font-bold uppercase  flex items-center gap-2">
                            <span className="w-1 h-4 bg-brand-green rounded-full"></span>
                            Historial de Bonificaciones por Excelencia
                        </h3>
                        <span className="text-[9px] font-black text-black/40 uppercase">Total: 15 Bonos</span>
                    </div>
                    
                    {/* Bonus Selector (Importer Simulation View) */}
                    <div className="mb-8 p-6 bg-black/40 border border-gray-400 shadow-sm rounded-2xl">
                        <p className="text-[9px] text-black font-black uppercase  mb-4 text-center">Ejecutar Bonificación de Calidad (Vista Importador)</p>
                        <div className="flex gap-3">
                            {[1, 2, 3].map(val => (
                                <button key={val} className="flex-1 py-4 bg-white border border-gray-400 shadow-sm rounded-xl hover:bg-brand-green hover:text-black transition-all flex flex-col items-center group">
                            ...
                            <div key={rec.id} className="p-5 rounded-2xl bg-white/2 border border-gray-400 shadow-sm hover:border-gray-400 shadow-sm transition-all">
                                    ...
                                    <div className="p-6 rounded-2xl border border-dashed border-gray-400 bg-white/50">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-[9px] font-bold text-black uppercase">Bono de 3$ Verificado · Custodia Axis Foundation</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {rec.type === 'tip' && (
                                    <div className="mt-3 inline-flex items-center gap-2 px-2 py-1 rounded bg-white border border-gray-400 shadow-sm">
                                        <span className="text-[9px] font-black text-black uppercase ">Reconocimiento Económico: {rec.amount}</span>
                                    </div>
                                )}
                            </div>
                        ))}
                ...
                <section className="bg-bg-card border border-gray-400 shadow-sm rounded-[32px] p-8 flex flex-col">
                    <h3 className="text-black-bright text-[11px] font-bold uppercase  mb-8 flex items-center gap-2">
                        <span className="w-1 h-4 bg-brand-green rounded-full"></span>
                    ...
                    <div className="flex-1 bg-black/40 rounded-2xl p-8 border border-gray-400 shadow-sm flex flex-col items-center text-center justify-center space-y-6">
                        ...
                        <div className="space-y-2">
                            <h4 className="text-lg font-black text-black uppercase leading-tight er">Portal de Educación AXIS</h4>
                        ...
                        <button className="w-full py-3 bg-brand-green text-black font-black uppercase text-[9px]  rounded-xl hover:bg-brand-green-bright transition-all">
                            Descargar Etiquetas de Retail (A4)
                        </button>
                    </div>

                    <div className="mt-6 p-4 bg-white border border-gray-400 shadow-sm rounded-xl">
                        <p className="text-[9px] text-black font-black uppercase leading-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-brand-green p-10 rounded-[40px] text-black relative overflow-hidden">
                    ...
                    <div className="mt-6 inline-block bg-black text-black px-4 py-2 rounded-xl font-black text-[9px]  uppercase">
                        CLEARING HOUSE ACTIVE
                    </div>
                </div>
                <div className="bg-white border border-gray-400 shadow-sm p-10 rounded-[40px] text-black relative overflow-hidden">
                    <h4 className="text-2xl font-black uppercase er leading-none mb-2 text-black-bright">Profit Sharing</h4>
                    ...
                    <div className="mt-6 flex gap-2">
                        {[1,2,3].map(v => (
                            <div key={v} className="px-3 py-1 bg-white border border-gray-400 shadow-sm rounded text-[11px] font-black text-black">+{v}$</div>
                        ))}
                    </div>
                </div>
            </div>
