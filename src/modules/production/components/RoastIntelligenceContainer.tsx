        ...
        <div className="space-y-12 animate-in fade-in duration-700">
            <header className="flex justify-between items-center bg-bg-card p-6 rounded-3xl border border-white/5 shadow-xl">
                ...
                <div className="flex gap-4">
                    ...
                    >
                        {demoMode ? '✨ MODO DEMO ON' : 'MODO REAL'}
                    </button>

                    <select
                        className="bg-bg-main border border-white/10 rounded-xl px-4 py-2 text-xs font-bold text-gray-300 outline-none focus:border-brand-green min-w-[280px] appearance-none"
                        onChange={(e) => {
