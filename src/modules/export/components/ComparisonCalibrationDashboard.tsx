            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        {historicalData.map((lot) => (
                            <div key={lot.id} className="group p-6 bg-bg-main border border-gray-400 shadow-sm rounded-2xl hover:border-gray-400 shadow-sm transition-all cursor-pointer">
                                <div className="flex justify-between items-center mb-4">
                                    <div>
                                        <p className="text-xs font-bold text-black">Lote: {lot.id}</p>
                                        <p className="text-[11px] text-gray-900 uppercase">{lot.notes}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-3xl font-bold er text-black-bright">{lot.sca_score}</p>
                ...
                <div className="space-y-8">
                    <div className="bg-bg-card border border-gray-400 shadow-sm rounded-[2.5rem] p-10">
                        <h3 className="text-xs font-bold text-black-bright uppercase  mb-6">IA Predictiva: Correlación</h3>
                        <div className="space-y-6">
                            <div className="p-6 bg-white border border-gray-400 shadow-sm rounded-2xl">
                                <p className="text-[9px] text-black font-medium uppercase mb-2">Análisis de Repetibilidad</p>
                                <p className="text-xs text-black leading-relaxed font-bold uppercase text-[9px] opacity-70">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center text-xs">
                                    <span className="text-black">Punto de First Crack</span>
                                    <span className="text-black font-mono">08:45</span>
                                </div>
                                <div className="flex justify-between items-center text-xs">
                                    <span className="text-black">Temp de Carga</span>
                                    <span className="text-black font-mono">205°C</span>
                                </div>
                                <div className="h-px bg-white"></div>
                                <button className="w-full py-3 bg-white border border-gray-400 shadow-sm text-black-bright rounded-xl text-[11px] font-bold uppercase hover:bg-brand-green/30 transition-all border border-gray-400 shadow-sm">Exportar Reporte para Seed Capital</button>
                            </div>
                        </div>
                    </div>
