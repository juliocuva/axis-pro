    ...
    if (!data) return (
        <div className="min-h-screen bg-bg-main flex flex-col items-center justify-center p-8 text-center">
            ...
            <button
                ...
                className="mt-12 px-10 py-4 bg-white hover:bg-white rounded-2xl text-[11px] font-bold uppercase  text-brand-navy border border-gray-200 shadow-sm transition-all"
            >
