            ...
            <div className="w-full">
                ...
                <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-2xl bg-brand-green p-6 rounded-[32px] shadow-[0_20px_50px_rgba(0,223,154,0.3)] flex flex-col md:flex-row items-center justify-between gap-4 z-50 animate-in slide-in-from-bottom-10 duration-1000">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-brand-green shadow-inner">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                            </svg>
                        </div>
                        <div className="text-black">
                            <h4 className="text-sm font-black uppercase tracking-tighter leading-none">Bono de Excelencia Disponible</h4>
                            <p className="text-[10px] font-bold uppercase tracking-widest opacity-70">Activación de Profit Sharing (Axis Foundation)</p>
                        </div>
                    </div>
                    <button 
                        onClick={() => {
                        ...
                        className="bg-black text-white px-8 py-3 rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-transform active:scale-95 shadow-xl"
                    >
                        Activar +3.00 USD
                    </button>
                </div>
