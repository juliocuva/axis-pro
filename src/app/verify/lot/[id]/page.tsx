            ...
            <div className="w-full">
                ...
                <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-2xl bg-brand-green p-6 rounded-[32px] shadow-[0_20px_50px_rgba(0,223,154,0.3)] flex flex-col md:flex-row items-center justify-between gap-4 z-50 animate-in slide-in-from-bottom-10 duration-1000">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-black shadow-inner">
                    ...
                    <button 
                        ...
                        className="bg-black text-black px-8 py-3 rounded-2xl font-black text-xs uppercase  hover:scale-105 transition-transform active:scale-95 shadow-xl"
                    >
                        Activar +3.00 USD
                    </button>
                </div>
