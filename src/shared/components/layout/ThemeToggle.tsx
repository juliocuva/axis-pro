    ...
    return (
        ...
        >
            {theme === 'light' ? (
                ...
                <>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-black-bright">
                        <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>
                    </svg>
                    <span className="text-[11px] font-bold uppercase  text-black">Modo Noche</span>
                </>
            )}
        </button>
    );
